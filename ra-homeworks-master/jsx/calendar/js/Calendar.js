    ...
    <div className="ui-datepicker">
      ...
      <div className="ui-datepicker-header">
        <div className="ui-datepicker-title">
          <span className="ui-datepicker-month">{upperFirst(date.toLocaleString("ru", {month: 'long'}))}</span>&nbsp;<span className="ui-datepicker-year">{date.toLocaleString("ru", {year: 'numeric'})}</span>
        </div>
      </div>
